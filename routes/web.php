...
Route::prefix('admin')->middleware('auth', 'admin')
    ...
    Route::resource('/uncategorized-materials', App\Http\Controllers\Admin\AdminUncategorizedMaterialController::class)->names('admin.uncategorized-materials');
    ...
    * ==================================== */
    ...
    Route::get('/external-api/dostv-migration-status', [App\Http\Controllers\Admin\External\AdminDostvController::class, 'migrationStatus'])->name('admin.external-api.dostv-migration-status.index');
