...
export default function EncoderDraftMaterialIndex( { auth } : PageProps ) {
  ...
  const { data, isFetching, error, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      const res = await axios.get(`/encoder/get-draft-materials?${params}`)
      return res.data
    },
...
EncoderDraftMaterialIndex.layout = (page: ReactNode) => (
