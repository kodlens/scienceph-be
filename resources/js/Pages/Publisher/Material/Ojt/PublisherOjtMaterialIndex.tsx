...
export default function PublisherOjtMaterialIndex({ auth }: PageProps) {
  ...
  const { data, isFetching, error, refetch } = useQuery({
    queryKey: ['publisher-ojt-materials', { perPage, page, appliedFilters }],
    queryFn: async () => {
      const params = [
        `perpage=${perPage}`,
      ...
      const res = await axios.get(`/publisher/get-ojt-materials?${params}`)
      return res.data
    },
...
PublisherOjtMaterialIndex.layout = (page: ReactNode) => (
