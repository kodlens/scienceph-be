            ...
            <Dropdown
              ...
              menu={{
                items: publisherMenuItems({
                  article,
                  handleEditClick: () =>
                    router.visit(`/publisher/articles/${article.id}/edit`),
                  handleTrashClick: async () => {
                    modal.confirm({
                      title: 'Move to Trash?',
                      content: 'This article will be moved to trash.',
                      onOk: async () => {
                        await axios.post(`/publisher/articles-trash/${article.id}`)
                        refetch()
                      },
                    })
                  },
                  ...
                  handlePublish: async () => {
                    await axios.post(`/publisher/articles-publish/${article.id}`).then(() => {
...
export default TablePublisherArticle
