...
export default function ActivityLogsIndex() {
  ...
  const { data, isFetching, error } = useQuery({
    queryKey: ['publisher-activity-logs', { perPage, page, appliedFilters }],
    queryFn: async () => {
      const params = [
        `perpage=${perPage}`,
      ...
      const res = await axios.get(`/publisher/get-activity-logs?${params}`)
      return res.data
    },
  ...
  function exportToExcel() {
    ...
    window.location.href = `/publisher/export-activity-logs?${params.toString()}`
  }
