            ...
            <div className="relative flex flex-wrap items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Track material performance, publishing activity, and content trends.
                </p>
              </div>
...
PublisherDashboard.layout = (page: any) => <PublisherLayout user={page.props.auth.user}>{page}</PublisherLayout>
