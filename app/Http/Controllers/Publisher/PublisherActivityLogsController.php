...
class PublisherActivityLogsController extends Controller
{
    ...
    {
        return Inertia::render('Publisher/ActivityLogs/ActivityLogsIndex');
    }
    ...
    public function export(Request $req)
    {
        ...
        $filename = 'publisher-activity-logs-' . now()->format('Ymd-His') . '.csv';
